export default function How_It_Works() {
  return (
    <div className="container mx-auto bg-background2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 place-items-center lg:grid-cols-3 gap-6 mt-8 bg-transparent p-3 pb-10 px-4">

...
export default function Footer() {
  ...
  return (
    <footer className=" px-4 md:px-16 lg:px-28 mt-20">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div>
          <h2 className="text-lg font-bold mb-4 ">About Us</h2>
          <p className="text-gray-300">
            Chereta is an Ethiopian made online marketplace where buyers and
            sellers from all over the world can either bid on items or list
            items so that buyers can bid on it.
          </p>
        </div>
        <div>

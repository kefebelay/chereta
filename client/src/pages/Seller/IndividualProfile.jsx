  ...
  useEffect(() => {
    if (user) {
      setProfile({
        ...
        address: user.individual_seller.address,
        description: user.individual_seller.description,
      });
  ...
  async function onUpdate() {
    try {
      ...
      if (
        ...
        profile.address === user.individual_seller.address &&
        profile.description === user.individual_seller.description
      ) {
